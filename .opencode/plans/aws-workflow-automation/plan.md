...
3. **Phase 3: The Orchestration Engine (Lambda)**
   - Implement Lambda logic: Port selection, ECS RunTask, and DynamoDB update.
4. **Phase 4: Integration & Delivery**
   - Connect API Gateway and integrate Resend for email delivery.
...
- [ ] Implement Lambda with ECS and DynamoDB permissions.
